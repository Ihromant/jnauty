...
public class _fpstate {
    ...
    private static final GroupLayout $LAYOUT = MemoryLayout.structLayout(
        NautyTraces.C_SHORT.withName("cwd"),
        NautyTraces.C_SHORT.withName("swd"),
        NautyTraces.C_SHORT.withName("ftw"),
        NautyTraces.C_SHORT.withName("fop"),
        NautyTraces.C_LONG.withName("rip"),
        NautyTraces.C_LONG.withName("rdp"),
        NautyTraces.C_INT.withName("mxcsr"),
        NautyTraces.C_INT.withName("mxcr_mask"),
        MemoryLayout.sequenceLayout(8, _fpxreg.layout()).withName("_st"),
        MemoryLayout.sequenceLayout(16, _xmmreg.layout()).withName("_xmm"),
        MemoryLayout.sequenceLayout(24, NautyTraces.C_INT).withName("__glibc_reserved1")
    ).withName("_fpstate");
    ...
    private static final long cwd$OFFSET = $LAYOUT.byteOffset(groupElement("cwd"));
    ...
    private static final long swd$OFFSET = $LAYOUT.byteOffset(groupElement("swd"));
    ...
    private static final long ftw$OFFSET = $LAYOUT.byteOffset(groupElement("ftw"));
    ...
    private static final long fop$OFFSET = $LAYOUT.byteOffset(groupElement("fop"));
    ...
    private static final long rdp$OFFSET = $LAYOUT.byteOffset(groupElement("rdp"));
    ...
    private static final long mxcsr$OFFSET = $LAYOUT.byteOffset(groupElement("mxcsr"));
    ...
    private static final long mxcr_mask$OFFSET = $LAYOUT.byteOffset(groupElement("mxcr_mask"));
    ...
    private static final long _st$OFFSET = $LAYOUT.byteOffset(groupElement("_st"));
    ...
    public static MemorySegment _st(MemorySegment struct, long index0) {
        try {
            return (MemorySegment)_st$ELEM_HANDLE.invokeExact(struct, _st$OFFSET, index0);
    ...
    private static final long _xmm$OFFSET = $LAYOUT.byteOffset(groupElement("_xmm"));
    ...
    public static MemorySegment _xmm(MemorySegment struct, long index0) {
        try {
            return (MemorySegment)_xmm$ELEM_HANDLE.invokeExact(struct, _xmm$OFFSET, index0);
        } catch (Error | RuntimeException ex) {
            throw ex;
        } catch (Throwable ex$) {
            throw new AssertionError("should not reach here", ex$);
    ...
    private static final long __glibc_reserved1$OFFSET = $LAYOUT.byteOffset(groupElement("__glibc_reserved1"));
    ...
    public static int __glibc_reserved1(MemorySegment struct, long index0) {
        return (int)__glibc_reserved1$ELEM_HANDLE.get(struct, __glibc_reserved1$OFFSET, index0);
    }
    ...
    public static void __glibc_reserved1(MemorySegment struct, long index0, int fieldValue) {
        __glibc_reserved1$ELEM_HANDLE.set(struct, __glibc_reserved1$OFFSET, index0, fieldValue);
    }
