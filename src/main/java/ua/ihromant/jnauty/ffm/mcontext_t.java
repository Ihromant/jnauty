...
public class mcontext_t {
    ...
    private static final GroupLayout $LAYOUT = MemoryLayout.structLayout(
        MemoryLayout.sequenceLayout(23, NautyTraces.C_LONG_LONG).withName("gregs"),
        NautyTraces.C_POINTER.withName("fpregs"),
        MemoryLayout.sequenceLayout(8, NautyTraces.C_LONG_LONG).withName("__reserved1")
    ).withName("$anon$133:9");
