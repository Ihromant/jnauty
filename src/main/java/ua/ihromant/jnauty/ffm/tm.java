...
public class tm {
    ...
    private static final GroupLayout $LAYOUT = MemoryLayout.structLayout(
        NautyTraces.C_INT.withName("tm_sec"),
        NautyTraces.C_INT.withName("tm_min"),
        NautyTraces.C_INT.withName("tm_hour"),
        NautyTraces.C_INT.withName("tm_mday"),
        NautyTraces.C_INT.withName("tm_mon"),
        NautyTraces.C_INT.withName("tm_year"),
        NautyTraces.C_INT.withName("tm_wday"),
        NautyTraces.C_INT.withName("tm_yday"),
        NautyTraces.C_INT.withName("tm_isdst"),
        MemoryLayout.paddingLayout(4),
        NautyTraces.C_LONG.withName("tm_gmtoff"),
        NautyTraces.C_POINTER.withName("tm_zone")
    ).withName("tm");
