...
public class sigaction {
    ...
    private static final GroupLayout $LAYOUT = MemoryLayout.structLayout(
        ...
        NautyTraces.C_INT.withName("sa_flags"),
        MemoryLayout.paddingLayout(4),
        NautyTraces.C_POINTER.withName("sa_restorer")
    ).withName("sigaction");
    ...
    public static class __sigaction_handler {
        ...
        private static final GroupLayout $LAYOUT = MemoryLayout.unionLayout(
            NautyTraces.C_POINTER.withName("sa_handler"),
            NautyTraces.C_POINTER.withName("sa_sigaction")
        ).withName("$anon$31:5");
