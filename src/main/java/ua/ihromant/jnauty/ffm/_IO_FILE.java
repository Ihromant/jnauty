...
public class _IO_FILE {
    ...
    private static final long _flags2$OFFSET = $LAYOUT.byteOffset(groupElement("_flags2"));
    ...
    private static final long __pad5$OFFSET = $LAYOUT.byteOffset(groupElement("__pad5"));
