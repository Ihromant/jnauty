...
public class _xstate {
    ...
    private static final long fpstate$OFFSET = $LAYOUT.byteOffset(groupElement("fpstate"));
    ...
    private static final long xstate_hdr$OFFSET = $LAYOUT.byteOffset(groupElement("xstate_hdr"));
    ...
    private static final long ymmh$OFFSET = $LAYOUT.byteOffset(groupElement("ymmh"));
